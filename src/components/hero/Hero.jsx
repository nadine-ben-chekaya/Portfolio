    ...
    return (
        ...
        <div className="container">
            <div className="hero-text">
                <p><span>NJ team </span>
                    are a Full-Stack Blockchain Developers From Tunisia.</p>
                <h1>We develop decentralised apps in web3 space.</h1>
                <h3>{description}</h3>
                {/*  =========popup bootstrap==========  */}
                    ...
                    <ModalBody>
                            <Row className="text-align">
                                <label htmlFor="" toggle={() => setModal(!modal)}>
                                    Mail Id - kidarjihen@gmail.com & nadinbenchekaya@gmail.com
                                </label>
            ...
            <div className="hero-img">
                ...
                <div className="img-container">
                    <img src={`src/assets/NJ.jpg`} alt="profilePhoto" />
                </div>
            </div>
        </div>
    </section>
